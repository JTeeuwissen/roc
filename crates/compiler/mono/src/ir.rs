...
use crate::layout::{
    ...
    LayoutRepr, Niche, RawFunctionLayout, STLayoutInterner, TLLayoutInterner, TagIdIntType,
...
impl<'a> Proc<'a> {
    ...
    pub fn insert_reset_reuse_operations<'i>(
        ...
        for proc in procs.values_mut() {
            let new_proc = crate::reset_reuse_old::insert_reset_reuse(
                arena,
                layout_interner,
                home,
                ident_ids,
